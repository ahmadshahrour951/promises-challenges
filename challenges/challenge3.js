 ...
 *    The async function is different in that it can handle asynchronous code using the await keyword, just like how a then block works on in promise chaining.
 ...
 *    a pending promise is printed, that is because console.log does not wait for the promise to resolve.
 * 
 * 
 * 3. Uncomment block #2 and run the code again. What happens now?
 *    The async function is resovled and it is chained with a .then() because it is a promise, in there the resolved promise is console logged.
 * 
 * 
